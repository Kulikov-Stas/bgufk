...
<div class="wrapper clearfix">
		...
		<?php } ?>
						...
						<?php if($options['mts_tags'] == '1') { ?>
							<div class="tags"><?php the_tags('<span class="tagtext">Метки:</span>',', ') ?></div>
						<?php } ?>
							</div>
					...
					<?php if($options['mts_author_box'] == '1') { ?>
                        ...
                        <h4><?php _e('About Author', 'mythemeshop'); ?></h4>
                            ...
                            <h5><?php the_author_posts_link(); ?> | <a href="<?php echo  get_the_author_meta( 'user_url');?>">Сайт</a> | <a href="http://twitter.com/<?php echo get_the_author_meta( 'twitter');?>">Twitter</a></h5>
