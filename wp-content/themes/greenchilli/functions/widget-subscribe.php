	...
	function widget( $args, $instance ) {
		...
		?>
			...
			<div class="mts-subscribe">
				...
				<input type="text" value="Ваш email..." onblur="if (this.value == '') {this.value = 'Ваш email...';}" onfocus="if (this.value == 'Ваш email...') {this.value = '';}"  name="email">
				<input type="hidden" value="<?php echo $desc; ?>" name="uri"><input type="hidden" name="loc" value="en_US"><input type="submit" value="">
				</form>
